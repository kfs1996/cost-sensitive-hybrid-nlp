...
def train_and_evaluate(dataset_name, algo, embed, fold_idx, X_train_emb, y_train, X_test_emb, y_test, num_classes, embed_dim):
    ...
    # [NEW] Cost-Sensitive Learning Injection
...
def main():
    ...
    results = []
    # Use max_workers=os.cpu_count() for maximum threads
    ...
    summary.to_csv(out_dir / "deep_learning_csl_reproduction.csv", index=False)
    print("Done! Saved to deep_learning_csl_reproduction.csv")
